$(document).ready(() => {
    ...
    $("#depositForm").on("submit", (e) => { 
        ...
        // convierte el input a numero si no es valido = NaN

        // Validación
        if (isNaN(monto) || monto < 2000) { 
            // si no es un numero o || el monto es inferior a 2000 aparece mensaje
        ...
        // recupera el historial si no, vacío
        ...
        // da 2 seg para leer el mensaje antes de redirigir
    });
